...
f025df05e8e2f07ec026496f7d20c4bf010fbf19	2022-12-16 00:14:42.930773+05:30	4
\.
...
27	2022-12-15 23:03:28.930465+05:30	6	Untitled, 6, test_user	3		15	1
28	2022-12-16 00:24:43.53917+05:30	7	TEST FILE, 7, test_user	1	[{"added": {}}]	15	1
29	2022-12-16 00:24:54.468428+05:30	1	FileAccess object (1)	1	[{"added": {}}]	18	1
30	2022-12-16 00:27:33.371041+05:30	1	FileAccess object (1)	3		18	1
31	2022-12-16 02:01:09.924064+05:30	2	FileAccess object (2)	3		18	1
32	2022-12-16 04:45:35.31459+05:30	4	FileAccess object (4)	1	[{"added": {}}]	18	1
33	2022-12-16 06:02:39.112969+05:30	4	FileAccess object (4)	3		18	1
34	2022-12-16 06:03:04.836991+05:30	9	child_folder, 9, test_user	1	[{"added": {}}]	16	1
35	2022-12-16 06:03:19.071283+05:30	10	child_child_folder, 10, test_user	1	[{"added": {}}]	16	1
36	2022-12-16 06:03:47.461529+05:30	11	child_child_child_folder, 11, test_user	1	[{"added": {}}]	16	1
37	2022-12-16 06:04:08.663854+05:30	7	TEST FILE, 7, test_user	2	[{"changed": {"fields": ["Parent"]}}]	15	1
38	2022-12-16 06:04:31.936288+05:30	8	chlid_test_file, 8, test_user	1	[{"added": {}}]	15	1
39	2022-12-16 06:05:10.625861+05:30	9	child_child_test_file, 9, test_user	1	[{"added": {}}]	15	1
\.
...
38	file_system	0007_remove_file_name_folder_unique_constraint_and_more	2022-12-15 23:03:14.737521+05:30
39	file_system	0008_alter_file_unique_together	2022-12-15 23:11:24.092529+05:30
40	file_system	0009_alter_fileaccess_file_alter_folderaccess_folder	2022-12-16 01:06:22.31765+05:30
41	file_system	0010_fileaccess_slug_folderaccess_slug	2022-12-16 02:01:03.819493+05:30
42	file_system	0011_alter_folderaccess_slug	2022-12-16 02:03:50.679593+05:30
43	file_system	0012_alter_file_users_alter_fileaccess_file_and_more	2022-12-16 02:18:13.016927+05:30
44	file_system	0013_rename_folder_file_parent_alter_file_unique_together	2022-12-16 04:21:53.559462+05:30
45	file_system	0014_alter_fileaccess_slug	2022-12-16 04:25:56.690257+05:30
\.
...
COPY public.file_system_file (id, name, file, created, updated, parent_id, owner_id, ext, size) FROM stdin;
7	TEST FILE	main_dqqWnyW.cpp	2022-12-16 00:24:43.536997+05:30	2022-12-16 06:04:08.661553+05:30	9	4	cpp	2604
8	chlid_test_file	main_J9ndCcX.cpp	2022-12-16 06:04:31.933616+05:30	2022-12-16 06:04:31.933644+05:30	10	4	cpp	2604
9	child_child_test_file	main_gY4C5Tn.cpp	2022-12-16 06:05:10.624052+05:30	2022-12-16 06:05:10.624073+05:30	11	4	cpp	2604
\.
...
COPY public.file_system_fileaccess (id, type, updated, created, file_id, user_id, slug) FROM stdin;
\.
...
9	child_folder	2022-12-16 06:03:04.833445+05:30	2022-12-16 06:03:04.833467+05:30	4	5
10	child_child_folder	2022-12-16 06:03:19.070018+05:30	2022-12-16 06:03:19.070036+05:30	4	9
11	child_child_child_folder	2022-12-16 06:03:47.460159+05:30	2022-12-16 06:03:47.460176+05:30	4	10
\.
...
COPY public.file_system_folderaccess (id, type, updated, created, folder_id, user_id, slug) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.file_system_file_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.file_system_fileaccess_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.file_system_folder_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.file_system_folderaccess_id_seq', 21, true);
...
--
-- Name: file_system_file file_system_file_name_folder_id_5a02a3c9_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_system_file
    ADD CONSTRAINT file_system_file_name_folder_id_5a02a3c9_uniq UNIQUE (name, parent_id);
...
--
-- Name: file_system_fileaccess file_system_fileaccess_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_system_fileaccess
    ADD CONSTRAINT file_system_fileaccess_slug_key UNIQUE (slug);


--
-- Name: file_system_fileaccess file_system_fileaccess_user_id_file_id_2d6be125_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_system_fileaccess
    ADD CONSTRAINT file_system_fileaccess_user_id_file_id_2d6be125_uniq UNIQUE (user_id, file_id);


--
-- Name: file_system_folder file_system_folder_name_parent_id_c0bea3b3_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_system_folder
    ADD CONSTRAINT file_system_folder_name_parent_id_c0bea3b3_uniq UNIQUE (name, parent_id);
...
--
-- Name: file_system_folderaccess file_system_folderaccess_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_system_folderaccess
    ADD CONSTRAINT file_system_folderaccess_slug_key UNIQUE (slug);


--
-- Name: file_system_folderaccess file_system_folderaccess_user_id_folder_id_9918f0d1_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_system_folderaccess
    ADD CONSTRAINT file_system_folderaccess_user_id_folder_id_9918f0d1_uniq UNIQUE (user_id, folder_id);
...
CREATE INDEX file_system_file_folder_id_d080d77a ON public.file_system_file USING btree (parent_id);
...
--
-- Name: file_system_fileaccess_slug_e9f96da6_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX file_system_fileaccess_slug_e9f96da6_like ON public.file_system_fileaccess USING btree (slug varchar_pattern_ops);
...
--
-- Name: file_system_folderaccess_slug_d36c76b7_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX file_system_folderaccess_slug_d36c76b7_like ON public.file_system_folderaccess USING btree (slug varchar_pattern_ops);
...
--
-- Name: file_system_file file_system_file_parent_id_8b237df9_fk_file_system_folder_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.file_system_file
    ADD CONSTRAINT file_system_file_parent_id_8b237df9_fk_file_system_folder_id FOREIGN KEY (parent_id) REFERENCES public.file_system_folder(id) DEFERRABLE INITIALLY DEFERRED;
